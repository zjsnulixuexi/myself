<template>
    <div class="home">
        <div class="content">
            <div class="stars"></div>
            <img class="bgc" src="../assets/1.webp" width="100%" alt="">
            <h3 class="title">欢迎来到阿极的个人网站</h3>
            <h3 class="titles">今天也要记得开心鸭</h3>
            <div class='ribbon'>
                <a href='/habbit'><span style="border-right: 2px #ccc solid;">爱好</span></a>
                <a href='./myself'><span style="border-right: 2px #ccc solid;">自述</span></a>
        ...
        <div class="icons">
            <div class="icons_items">
                <img class="icons_items_imgs" src="../assets/school.jpg" alt="">
                <span>中石大学子</span>
            </div>
            <div class="icons_items">
                <img class="icons_items_imgs" src="../assets/book.jpg" alt="">
                <span>计算机大三本科在读</span>
            </div>
            <div class="icons_items">
                <img class="icons_items_imgs" src="../assets/guitar.jpg" alt="">
                <span>会点吉他</span>
            </div>
            <div class="icons_items">
                <img class="icons_items_imgs" src="../assets/game.jpg" alt="">
                <span>爱打游戏</span>
            </div>
        </div>
        <div class="introduce">
            <div class="introduce_item">
                <img class="introduce_item_img" src="../assets/introduce.jpg" alt="">
                <span class="introduce_item_title"> --
                    滑到这里了，那么我叫什么，是什么样的人呢，又该如何正确的认识我，那就再重新介绍一下</span>

            </div>
            <div class="introduce_item">

                <span class="introduce_item_titles">
                    <div style="margin-top: 100px;">姓名：张京生</div>
                    <div>性别：男</div>
                    <div>现读学校：中国石油大学 （北京）</div>
                    <div>出生年份：2005</div>
                    <div>性格：外i内e（努力变e）</div>
                    <div>企鹅号：499342513</div>
                    <div>电话：15984098235</div>
                    <div>个人简述：社恐，尝试改变</div>

                </span>
                <img class="introduce_item_img" src="../assets/introduce2.jpg" alt="">
            </div>
            <div class="introduce_item">
                <img class="introduce_item_img" src="../assets/introduce3.jpg" alt="">
                <span class="introduce_item_title">什么？发现看了跟没看一样！big胆！那就<span id="font_click">
                        <p @click="totop">点击此处</p>
                    </span>回到网页最上方导航到其他地方吧</span>
            </div>
        </div>
        ...
        <img class="music_img" src="../assets/musicbgi.jpg" alt="">
    </div>
</template>
